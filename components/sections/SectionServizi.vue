...
export default {
  ...
  data: () => ({
    servizi: [
      {
        animationFile: 'web-design-illustration.json',
      ...
      {
        animationFile: 'business-analytics.json',
      ...
      {
        animationFile: 'chat-platform-animation.json',
      ...
      {
        animationFile: 'marketing-growth.json',
      ...
      {
        animationFile: 'web-designer-animation.json',
